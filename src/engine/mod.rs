...
pub use graphql::{
    ...
    ActivityExecuteInput,               // Input for executing activities

    ActivityGQL,       // Activity definition for GraphQL responses
    ActivityRecordGQL, // NATS activity tracking
    ...
    ExecuteActivityWithNATSInput, // Input for NATS-tracked activities
    HistoryEventGQL,             // History event for GraphQL responses

    // NATS-specific GraphQL types
    NATSResourceGQL,       // Enhanced resource with NATS metadata
    ResourceCreateInput,   // Input for creating resources
    ResourceGQL,           // Resource state for GraphQL responses
    ResourcesInStateInput, // Input for querying resources in specific states
...
/// - ResourceEvents: Extension trait for emitting events from resource operations
pub use events::{EventBus, ResourceEvents};
...
pub use agents::{
    AgentEngine, AgentEngineConfig, AgentStorage, ExecutionStats, InMemoryAgentStorage,
};
...
pub use nats_storage::{NATSStorage, NATSStorageConfig, NATSStorageWrapper, WorkflowStreamManager};
